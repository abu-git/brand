            ...
            <div className='bg-white dark:bg-slate-900'>
                ...
                <section className="flex flex-col mt-2 mx-auto">
                        <div className="mx-8 lg:mx-16">
                            ...
                            <h3 className="text-lg lg:text-2xl font-light text-black dark:text-white text-center mb-5 px-8">published: {(new Date(post.attributes.publishedAt)).toDateString()}</h3>
                        </div>
...
export async function getServerSideProps({ params: {slug} }){
    ...
    const cloudinaryUrl = cloudinary.url('card-background_gks1q4', {
        width: 1012,
        height: 506,
        transformation: [
          {
