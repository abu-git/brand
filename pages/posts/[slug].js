        ...
        >
            <div className='bg-white dark:bg-slate-900'>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3  mt-5 md:mb-32 mx-6 md:mx-24 lg:mx-48">
                    <a target="_blank" href={post.attributes.youtube}>
                        <div className="bg-white dark:bg-slate-800 py-5 px-3 rounded-md shadow-md hover:shadow-lg flex justify-center cursor-pointer">
                            <h5 className="text-md font-thin">YouTube</h5>
                    ...
                    <a target="_blank" href={post.attributes.spotify}>
                        <div className="bg-white dark:bg-slate-800 py-5 px-3 rounded-md shadow-md hover:shadow-lg flex justify-center cursor-pointer">
                            <h5 className="text-md font-thin">Spotify</h5>
                    ...
                    <a target="_blank" href={post.attributes.itunes}>
                        <div className="bg-white dark:bg-slate-800 py-5 px-3 rounded-md shadow-md hover:shadow-lg flex justify-center cursor-pointer">
                            <h5 className="text-md font-thin">iTunes</h5>
