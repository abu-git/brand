    ...
    <>
        <div className='mt-8 mb-8 px-6 grid md:grid-cols-2 lg:grid-cols-3 gap-10'>
            ...
            <div className='flex flex-col cursor-pointer bg-white dark:bg-slate-800 dark:text-gray-100 rounded overflow-hidden drop-shadow-lg hover:drop-shadow-2xl'>
                ...
                <span className='text-sm text-gray-700 dark:text-gray-100 mt-2 mb-2 text-justify px-3'>
        ...
        <div className='flex justify-center mt-12'>
            <Link href="/posts">
            <div className='rounded-full py-2 px-3 uppercase font-bold cursor-pointer tracking-wider border-black dark:border-white border-2 hover:text-white hover:bg-black transition ease-out duration-500'>More Posts</div>
            </Link>
        </div>
    </>
  )
