    ...
    return (
        <main className='flex flex-col mt-16 pt-4 pb-4 mx-4 dark:text-gray-100'>
            <motion.h3 
                ...
                className='text-md md:text-lg font-semibold text-center pb-2'>Song of the Day - <span className="font-bold text-amber-600">CROWN OF THORNS</span> by Mxps Rellington &amp; Lyrical Ogele</motion.h3>
