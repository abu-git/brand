    ...
    return (
        <main className='flex flex-col mt-16 pt-4 pb-4 mx-4 dark:text-gray-100'>
            <motion.h3 
                ...
                className='text-md md:text-lg font-semibold text-center pb-2'>Song of the Day - <span className="font-bold text-amber-600">Summer Society Theme</span> by Teck Zilla</motion.h3>
            <div className='flex justify-center ml-6 md:ml-48 lg:ml-80'>
                <div className={styles.audioPlayer}>
                    <audio ref={audioPlayer} src="/audio/sotd-teck.mp3" type="audio/mpeg" preload="auto"></audio>
