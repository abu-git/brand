  ...
  return (
    <>
        <div className='mt-6 mb-3 text-center ml-2 mr-2 md:ml-4 md:mr-4'>
            <h2 className='text-2xl md:text-4xl p-1 bg-clip-text text-transparent bg-gradient-to-l from-cyan-200 to-sky-900'>There are a ton of amazing creations by African artists. <span className='font-bold'>tunesketch</span> aims to give these gems the proper showcase that they deserve. Get a little taste from our highlighted playlists below</h2>
        </div>
        ...
        <section className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-2 justify-items-center'>
            <div className='bg-white dark:bg-slate-800 px-3 py-5 rounded drop-shadow-lg'>
                <h4 className='text-lg mb-2 text-orange-400'>African BoomBap Spotify Playlist 1</h4>
            ...
            <div className='bg-white dark:bg-slate-800 px-3 py-5 rounded drop-shadow-lg'>
                <h4 className='text-lg mb-2 text-red-500'>Fresh Africa Feel Good</h4>
