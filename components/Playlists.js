  ...
  return (
    <>
        <div className='mt-6 mb-3 text-center ml-2 mr-2 md:ml-4 md:mr-4'>
            <h2 className='text-2xl md:text-4xl p-1 bg-clip-text text-transparent bg-gradient-to-l from-yellow-400 to-green-800'>There are a ton of amazing creations by African artists. <span className='font-bold'>Kulture Launders</span> aims to give these gems the proper showcase that they deserve. Get a little taste from our highlighted playlists below</h2>
        </div>
