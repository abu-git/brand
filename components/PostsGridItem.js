...
function PostsGridItem({post}) {
    ...
    return (
        <Link href={`/posts/${post.attributes.slug}`} passHref>
            <div className='flex bg-white rounded overflow-hidden drop-shadow-lg md:rounded md:drop-shadow-lg hover:drop-shadow-xl dark:bg-slate-800 mb-4 max-h-96 cursor-pointer'>
