...
function Navigation() {
    ...
    <div className='font-body py-4 px-8 rounded shadow-md bg-white dark:bg-slate-900 dark:text-gray-100 fixed top-0 z-10 w-full'>
        <nav className='flex justify-between'>
            {/* Logo  */}
            <Link href="/">
                {/*<a className='w-1/3 md:w-1/4 sm:text-lg md:text-xl font-bold bg-clip-text text-transparent bg-gradient-to-l from-yellow-400 to-teal-700'>
                    Brand.
                </a>*/}
                <div className='flex items-center w-1/2 md:w-1/4 cursor-pointer'>
                    ...
                    />
                    <h3 className='sm:text-md md:text-xl font-bold bg-clip-text text-transparent bg-gradient-to-l from-yellow-400 to-green-800'>tunesketch</h3>
                </div>
            </Link>
